...
function validateFields(form) {
  ...
  if (!form.fieldOfActivity.trim())
    errors.fieldOfActivity = "Field of activity is required.";
  if (!form.phone.trim()) {
      ...
      <div className="cu-top">
        ...
        <TextAnimation animateOnScroll={true} delay={0.3}>
          <p className="cu-desc">
            ...
            Or Organizational Efficiency, Or If You&apos;re Seeking Expert
            Guidance On People Strategies, We&apos;re Here To Help. Drop Your
            Details Below, And One Of Our Experts Will Reach Out.
          </p>
        </TextAnimation>
      </div>
          ...
          {success && (
            <div className="cu-success-banner">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                  d="M10 0C4.477 0 0 4.477 0 10s4.477 10 10 10 10-4.477 10-10S15.523 0 10 0zm4.707 7.707-5.5 5.5a1 1 0 0 1-1.414 0l-2.5-2.5a1 1 0 1 1 1.414-1.414L8.5 11.086l4.793-4.793a1 1 0 1 1 1.414 1.414z"
                  fill="currentColor"
                />
              </svg>
          ...
          <form className="cu-form" onSubmit={handleSubmit} noValidate>
            <div className="cu-row">
              <div className="cu-field">
                ...
                />
                {errors.companyName && (
                  <span className="cu-field-error">{errors.companyName}</span>
                )}
              </div>
              <div className="cu-field">
            ...
            <div className="cu-row">
              <div className="cu-field">
                ...
                />
                {errors.phone && (
                  <span className="cu-field-error">{errors.phone}</span>
                )}
              </div>
              <div className="cu-field">
                ...
                />
                {errors.email && (
                  <span className="cu-field-error">{errors.email}</span>
                )}
              </div>
            </div>
      ...
      <div className="cu-contacts">
        ...
        <div className="cu-contact-item">
          ...
          <div className="cu-contact-text">
            <TextAnimation animateOnScroll={true} delay={0.3}>
              <p>
                2nd floor | Office no 15 | Viva Towers | Ali Hassan Mwinyi Rd |
        ...
        <div className="cu-contact-item">
          <div className="cu-icon">
            ...
            >
              <path
                d="M30 3C30 1.35 28.65 0 27 0H3C1.35 0 0 1.35 0 3V21C0 22.65 1.35 24 3 24H27C28.65 24 30 22.65 30 21V3ZM27 3L15 10.5L3 3H27ZM27 21H3V6L15 13.5L27 6V21Z"
                fill="white"
              />
            </svg>
          </div>
