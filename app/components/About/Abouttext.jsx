...
const AboutText = () => {
  ...
  useEffect(() => {
    ...
    // Defer by one frame so the new page layout is painted before ScrollTrigger
    // calculates element positions — fixes the "works on refresh, not on navigate" bug.
    let tl, split;
    ...
    const rafId = requestAnimationFrame(() => {
      ...
      tl.to(primaryChars, { color: "#1a1a1a", stagger: 1 }).to(secondaryChars, {
        color: "#000",
        stagger: 1,
      });
      ...
      // Force ScrollTrigger to recalculate all positions after navigation
        ...
        <div className="about-text-content">
          ...
          <p ref={textRef} className="about-text-text">
            <span ref={primaryRef} className="about-text-primary">
              ...
              clarity, strategy, and purpose. We partner
              {/* <span ref={secondaryRef} className="about-text-secondary"> */}
              with businesses to strengthen workplace performance, develop
              leaders, improve team dynamics, and create environments where both
              people and organisations can grow sustainably
            </span>
            {/* </span> */}
          </p>
        </div>
