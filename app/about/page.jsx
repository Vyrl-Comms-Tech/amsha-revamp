...
export const metadata = {
 title: "About Amsha Advisory | HR Consultancy for Tanzania & Dubai",
  description:
    "Learn about Amsha Advisory, your trusted HR consultancy delivering tailored solutions in talent, training, and strategy across Tanzania and Dubai.",
};
const page = () => {
  return (
    <div>
